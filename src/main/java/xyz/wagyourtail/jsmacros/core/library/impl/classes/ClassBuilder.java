...
public class ClassBuilder<T> {
    ...
    public ClassBuilder(String name, Class<T> parent, Class<?>... interfaces) throws NotFoundException, CannotCompileException {
        ...
        ctClass = defaultPool.makeClass("xyz.wagyourtail.jsmacros.main.library.impl.classes.proxypackage." + className);
    ...
    public class MethodBuilder {
        ...
        public ClassBuilder<T> guestBody(MethodWrapper<Object, Object, Object, ?> methodBody) throws CannotCompileException, NotFoundException {
            ...
            body.append("((xyz.wagyourtail.jsmacros.main.MethodWrapper)")
                    .append("xyz.wagyourtail.jsmacros.main.library.impl.classes.ClassBuilder.methodWrappers.get(\"")
                    .append(guestName)
                    .append("\")).")
